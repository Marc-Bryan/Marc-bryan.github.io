        ...
        <VerticalTimeline lineColor="#3e497a">
          ...
          >
            <h3 className="vertical-timeline-element-title">
              Frontend Engineer - Samsung Research Institute Philippines
            </h3>
            <h4 className="vertical-timeline-element-subtitle">
              Taguig City, Philippines
            </h4>
            <ul>
              <li>Spearhead<b> gRPC implementation to web improving API call speed 50%</b></li>
              <li>Implement InxededDB <b>reducing api calls by 80% </b></li>
              <li>Assist in translating <b>global language</b>, improving code readability and maintainability of global development team</li>
            </ul>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
